...
import classes from "../styles/pages/PrivacyPolicy.module.css";
...
export default function TermsAndConditions() {
  return (
    <div className={classes.main}>
      <Head>
        <title>Panthart | Terms & Conditions</title>
      </Head>
      <h2>
        <strong>Terms and Conditions</strong>
      </h2>

      <p className={classes.headText}>Welcome to Panthart!</p>

      <p className={classes.headText}>
        These terms and conditions outline the rules and regulations for the use
        of Panthart's Website, located at https://panthart.com.
      </p>

      <p className={classes.headText}>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Panthart if you do not agree to take
      ...
      <p className={classes.headText}>
        We employ the use of cookies. By accessing Panthart, you agreed to use
        cookies in agreement with the Panthart's Privacy Policy.{" "}
      </p>
      ...
      <p className={classes.headText}>
        Unless otherwise stated, Panthart and/or its licensors own the
        intellectual property rights for all material on Panthart. All
        intellectual property rights are reserved. You may access this from
        Panthart for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p className={classes.headText}>You must not:</p>
      <ul className={classes.headText}>
        <li>Republish material from Panthart</li>
        <li>Sell, rent or sub-license material from Panthart</li>
        <li>Reproduce, duplicate or copy material from Panthart</li>
        <li>Redistribute content from Panthart</li>
      </ul>
      ...
      <p className={classes.headText}>
        ...
        Panthart does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Panthart,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, Panthart shall not be liable
      ...
      <p className={classes.headText}>
        Panthart reserves the right to monitor all Comments and to remove any
        Comments which can be considered inappropriate, offensive or causes
        breach of these Terms and Conditions.
      </p>

      <p className={classes.headText}>You warrant and represent that:</p>
      ...
      <p className={classes.headText}>
        You hereby grant Panthart a non-exclusive license to use, reproduce,
      ...
      <p className={classes.headText}>
        ...
        the hyperlink compensates the absence of Panthart; and (d) the link is
        in the context of general resource information.
      </p>

      <p className={classes.headText} v>
      ...
      <p className={classes.headText}>
        ...
        e-mail to Panthart. Please include your name, your organization name,
      ...
      <p className={classes.headText}>
        No use of Panthart's logo or other artwork will be allowed for linking
      ...
      <p className={classes.headText}>Please read Privacy Policy</p>
