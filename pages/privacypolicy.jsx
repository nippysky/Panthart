...
export default function PrivacyPolicy() {
  return (
    <div className={classes.main}>
      <Head>
        <title>Panthart | Privacy Policy</title>
      </Head>
      <h1>Privacy Policy</h1>
      <p className={classes.headText}>Last updated: July 01, 2022</p>
      ...
      <ul className={classes.headText}>
        ...
        <li>
          <p className={classes.headText}>
            ...
            this Agreement) refers to Panthart, Abuja, Nigeria.
          </p>
        </li>
        <li>
          <p className={classes.headText}>
        ...
        <li>
          <p className={classes.headText}>
            <strong>Website</strong> refers to Panthart, accessible from{" "}
            <a
      ...
      <ul className={classes.headText}>
        <li>
          <p className={classes.headText}>Email address</p>
        </li>
        <li>
          <p className={classes.headText}>First name and last name</p>
        </li>
        <li>
          <p className={classes.headText}>Usage Data</p>
        </li>
      </ul>
      <h3>Usage Data</h3>
      <p className={classes.headText}>
      ...
      <ul className={classes.headText}>
        <li>
          ...
          <p className={classes.headText}>Type: Session Cookies</p>
          <p className={classes.headText}>Administered by: Us</p>
          <p className={classes.headText}>
        ...
        <li>
          ...
          <p className={classes.headText}>Type: Persistent Cookies</p>
          <p className={classes.headText}>Administered by: Us</p>
          <p className={classes.headText}>
      ...
      <ul className={classes.headText}>
        <li>By email: panthartofficial@gmail.com</li>
      </ul>
    </div>
  );
}
