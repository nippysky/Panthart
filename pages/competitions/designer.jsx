...
export default function Designer() {
  return (
    <section className={classes.section}>
      <Head>
        <title>Panthart | Competitions - Designer</title>
      </Head>
      <div>
        <Image
          src="/images/competitions/Designer.jpg"
          alt="Designer"
          height={620}
          width={930}
          priority
      ...
      <div className={classes.compDetails}>
        ...
        <p className={classes.compText}>
          ...
          is to come up with a creative branding concept for Panthart. This
          includes logo, fonts, colors and everything concerned with branding.
        </p>
        ...
        <p style={{ fontWeight: "bolder", fontSize: "1rem" }}>
          ...
          >
            <Link href="https://forms.gle/AfVAsNPag7UXsyMH8"> Submit Here</Link>
          </span>
        </p>
      </div>
